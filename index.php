...
$mottoSource = netsukoOption('mottoSource', 'custom');
...
<div id="home-banner" class="w-full relative mb-12 flex items-center justify-center overflow-hidden border-b border-gray-200/50 dark:border-white/5 <?php echo $hasBanner ? 'bg-cover bg-center' : 'bg-white/30 dark:bg-darkCard/30 backdrop-blur-md'; ?>" 
    ...
    <div class="relative z-10 text-center px-4">
        <h1 id="home-motto" class="text-3xl md:text-5xl <?php echo $mottoFont == 'sans' ? 'font-sans not-italic' : 'font-playfair italic'; ?> font-semibold text-glow transition-all duration-500" data-motto-text="<?php echo netsukoEscape($mottoBanner); ?>" data-motto-source="<?php echo netsukoEscape($mottoSource === 'hitokoto' ? 'hitokoto' : 'custom'); ?>" data-motto-typing="<?php echo netsukoEscape($mottoTyping === 'on' ? 'on' : 'off'); ?>" data-motto-quotes="<?php echo netsukoEscape($mottoQuotes === 'show' ? 'show' : 'hide'); ?>" aria-live="polite">
